// Stage A — deterministic rules. Same code as supabase/functions/_shared/score.ts;
// both mirror app/lib/scoring/score_engine.dart + score_config.dart. Keep all three in step:
